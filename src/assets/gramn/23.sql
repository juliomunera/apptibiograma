...
VALUES ('GRAMNegativo-Pseudomonas-Etapa2', 'Ceftazidime y/o Cefepime son un numero entero o son resistentes.');
...
*/
INSERT INTO BitacoraEventos (TipoEvento, DetalleEvento) 
VALUES ('GRAMNegativo-Pseudomonas-Etapa2', 'Ingresando la asignación de medicamentos (ARk) cuando 1.	E.coli y Proteus mirabilis.');
...
FROM
	...
	(
		...
		WHERE
			...
			(dp1.idParteDelCuerpo = 3 AND a.id IN (33,42)) OR
...
*/
INSERT INTO BitacoraEventos (TipoEvento, DetalleEvento) 
VALUES ('GRAMNegativo-Ecoli-Etapa2', 'Eliminando Piperacilina/tazobactam.');
...
*/
INSERT INTO BitacoraEventos (TipoEvento, DetalleEvento) 
VALUES ('GRAMNegativo-Pseudomonas-Etapa2', 'Ingresando la asignación de medicamentos (ARk) cuando Pseudomonas.');
...
FROM
	...
	(
		...
		WHERE
			...
			(dp1.idParteDelCuerpo = 5 AND a.id IN (32,33,36,49)) OR
...
FROM
	...
	(
		...
		WHERE
			...
			(dp1.idParteDelCuerpo = 5 AND a.id IN (36,39,40,49)) OR
